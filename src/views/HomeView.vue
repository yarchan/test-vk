...
export default {
  ...
  setup(){
    ...
    const v = '5.154'
    const vkAuthUrl = `https://oauth.vk.com/authorize?client_id=51773846&display=page&redirect_uri=https://jolly-cendol-1d3a96.netlify.app/list-friends&scope=friends&response_type=token&v=5.131&state=123456`;
    return{
      v,
      AppID,
      vkAuthUrl
